...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-dark text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Salarios Empresa</a>
        ...
        <section class="page-section bg-white text-black mb-0" id="about">
            <div class="container">
                ...
                <!-- Icon Divider-->
                <div class="page-section bg-white text-black mb-0">
             
                </div>
                <!-- About Section Content-->
                <div class="row">
                    <div class="bg-white col-lg-4 ms-auto"><p class="lead"><?php  
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Tu sitio web se Salarios, @jess</small></div>
        </div>
        <!-- Bootstrap core JS-->
